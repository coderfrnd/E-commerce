  ...
  return (
    <div className="">
      ...
      <div className="mx-2 my-4">
        <p className="text-sm">
          <b>Fire-Boult</b> Hurricane 1.33 inches Curved Glass Display with 360
          Health Training1 100+ Sports Modes Smartwatch (Gray Strap, Free Size){" "}
        </p>
        ...
        <div className="flex items-center">
          ...
          <h2 className="mx-2 font-semibold text-slate-700 text-xl">₹1,999</h2>
        </div>
        ...
        <div className="">
          ...
          <div>
            <ol className="list-disc text-sm p-4 m-1">
              <li>
                1.3 color HD full touch screen with 240*240 pixel resolution
              </li>
              <li>
                2.5D Curved glass for best retina HD colour Display with
                automatic motion recoginition
              </li>
              <li>
                SpO2 monitoring, continous Heart Rate tracking | 100+ sports
                modes | IP67 Water resistance
              </li>
              <li>Superior Battery life 7 Days | standby Time 15 days</li>
              <li>Fitness and outdoor, Health & Medical</li>
            </ol>
          </div>
        </div>
      </div>
